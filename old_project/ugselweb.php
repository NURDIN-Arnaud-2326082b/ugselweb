<?php 
	...
	$Couleurs = Array(
		Array("Oc�an"    ,"darkblue","White","White","aliceblue","#C0DBEC","#DDDDDD","#EEEEEE","#C0DBD0","#a0e0e0","#e0a0ff","indigo","Green","Red","#000080","darkblue","#FFFF99"),
			...
			if (($menu == "competitions") && ($sousmenu == "individuels")) {
				if ((!(isset($BValidernumlicence))) || (empty($BValidernumlicence))) {
					...
					if ($reqlic) {
						...
						if ($reslic) {
							$reflic = sprintf('%010s',$reslic['LicNumLicence'])." ".$reslic['LicNom']." ".$reslic['LicPr�nom'];
